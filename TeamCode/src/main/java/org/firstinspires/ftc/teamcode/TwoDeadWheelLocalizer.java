...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 0.0055768995171091825; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 0.09137258647267509; // x position of the perpendicular encoder (in tick units)
    }
